...
- (IBAction)pay:(UIButton *)sender {
    ...
    UIAlertController * vc =[UIAlertController alertControllerWithTitle:@"温馨提示" message:@"如果您在购物过程出现任何问题,都可以去 我的->意见反馈->联系客服" preferredStyle:(UIAlertControllerStyleActionSheet)];
