                         ...
                         model:(id<IMessageModel>)model
{
    ...
    _hasRead.accessibilityIdentifier = @"已读";
    _hasRead.translatesAutoresizingMaskIntoConstraints = NO;
    _hasRead.text = @"已读";
    _hasRead.textColor = [UIColor colorWithRed:96/255.0 green:116/225.0 blue:126/255.0 alpha:1.0];
        ...
        switch (messageType) {
            case EMMessageBodyTypeText:
            {
                ...
                if (model.isSender) {
                    ...
                    _bubbleView.textLabel.font = _messageTextFont;
                    _bubbleView.textLabel.textColor = [UIColor colorWithRed:96/255.0 green:116/225.0 blue:126/255.0 alpha:1.0];
                }
